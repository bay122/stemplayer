    ...
    def parse(file_path):
        ...
        for line in lines:
            ...
            if sec_match:
                ...
                # If we had content in current section, save it
            ...
            if comment_match:
                # Treat as section divider if it's a standalone comment like {c: Chorus}
...
class ChordProEditor(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.export_pdf_btn.setStyleSheet("background-color: #2196F3; color: white; padding: 5px 15px; font-weight: bold;")
        self.export_pdf_btn.clicked.connect(self.export_pdf)
        toolbar.addWidget(self.export_pdf_btn)
        
        save_btn = QPushButton("Guardar Archivo")
        save_btn.setStyleSheet("background-color: #4CAF50; color: white; padding: 5px 15px; font-weight: bold;")
        ...
        self.preview.setStyleSheet("background-color: #1E1E1E; color: #FFFFFF; padding: 10px;")
    ...
    def save_file(self):
        ...
        with open(self.file_path, "w", encoding="utf-8") as f:
            ...
            if meta.get("title"): f.write(f"{{title: {meta['title']}}}\n")
            if meta.get("artist"): f.write(f"{{artist: {meta['artist']}}}\n")
            if meta.get("key"): f.write(f"{{key: {meta['key']}}}\n\n")
    ...
    def export_pdf(self):
        ...
        for sec in self.parsed_data["sections"]:
            ...
            # Para impresión forzamos color negro y márgenes para los acordes
